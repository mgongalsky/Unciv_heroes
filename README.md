...
Размер основанного города зависит от уровня героя и размера его армии. Такие поселения позволяют прокормить армию, если заканчивается провизия и основать новый город. Но сам герой, при этом теряется, хотя некоторые из его навыков могут быть полезными для управления городом.
...
Вступайте в чаты - там решим. Вот есть [телеграм](https://t.me/+NWXt8maGBMowZGU6), позже, возможно, будет дискорд. Я постараюсь написать инструкции для решения конкретных задач (куда копать).
